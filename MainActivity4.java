    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (input.length() == 0) {
                    Toast.makeText(MainActivity4.this, "Field can't be empty", Toast.LENGTH_SHORT).show();
                    return;
                }

                long millisInput = Long.parseLong(input) * 60000;
                if (millisInput == 0) {
                    Toast.makeText(MainActivity4.this, "Please enter a positive number", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void startTimer() {
        ...
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(getApplicationContext(),"Timer has stopped",Toast.LENGTH_LONG).show();
            }
        }.start();
